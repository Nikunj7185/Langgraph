...
class StackOverFlowToolInput(BaseModel):
    query: str = Field(..., description="The search query for Stack Overflow")
...
Stack_overflow_tool = StructuredTool.from_function(
    func=answers,
    name = "StackOverflow Question Answerer",
    description = "Given any coding related user query ,it tries to find the most relevent answers from Stack Overflow based only on the provided upvoted responses.",
